...
* \param frame the cv::Mat containing the sqaure block frame
* \return cv::Mat containing only the square face of the block.
*/
...
* \param blockFace the cv::Mat containing only the block face.
  \param imageList a vector of cv::Mat containing all the faces of the blocks
